...
namespace Lambda
{
	...
	inline D3D12_RESOURCE_STATES ConvertResourceState(ResourceState state)
	{
		...
		case RESOURCE_STATE_RENDERTARGET_PRESENT:		return D3D12_RESOURCE_STATE_PRESENT;
		...
		case RESOURCE_STATE_DEPTH_STENCIL:				return D3D12_RESOURCE_STATE_DEPTH_WRITE;
	...
	inline ResourceState ConvertD3D12ResourceState(D3D12_RESOURCE_STATES state)
	{
		switch (state)
		{
		case D3D12_RESOURCE_STATE_RENDER_TARGET:				return RESOURCE_STATE_RENDERTARGET;
		case D3D12_RESOURCE_STATE_COMMON:						return RESOURCE_STATE_RENDERTARGET_PRESENT;
		case D3D12_RESOURCE_STATE_COPY_DEST:					return RESOURCE_STATE_COPY_DEST;
		case D3D12_RESOURCE_STATE_COPY_SOURCE:					return RESOURCE_STATE_COPY_SRC;
		case D3D12_RESOURCE_STATE_DEPTH_WRITE:					return RESOURCE_STATE_DEPTH_STENCIL;
		case D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER:	return RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER;
		case D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE:		return RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
		case D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE:	return RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE;
	...
	inline D3D12_COMMAND_LIST_TYPE ConvertCommandListType(DeviceContextType type)
	{
		switch (type)
		{
		case DEVICE_CONTEXT_TYPE_GRAPHICS:	return D3D12_COMMAND_LIST_TYPE_DIRECT;
		case DEVICE_CONTEXT_TYPE_COMPUTE:	return D3D12_COMMAND_LIST_TYPE_COMPUTE;
		case DEVICE_CONTEXT_TYPE_COPY:		return D3D12_COMMAND_LIST_TYPE_COPY;
		default:							return D3D12_COMMAND_LIST_TYPE(0);
		}
	}
}