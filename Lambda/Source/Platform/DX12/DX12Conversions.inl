...
namespace Lambda
{
	...
	inline D3D12_COMMAND_LIST_TYPE ConvertCommandListType(CommandListType type)
	{
		switch (type)
		{
		case COMMAND_LIST_TYPE_GRAPHICS:	return D3D12_COMMAND_LIST_TYPE_DIRECT;
		case COMMAND_LIST_TYPE_COMPUTE:		return D3D12_COMMAND_LIST_TYPE_COMPUTE;
		case COMMAND_LIST_TYPE_COPY:		return D3D12_COMMAND_LIST_TYPE_COPY;
