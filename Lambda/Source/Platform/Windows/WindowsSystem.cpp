...
namespace Lambda
{
	...
	EKey	CWindowsSystem::s_WindowsKeyTable[256];
	uint32	CWindowsSystem::s_KeyTable[uint32(EKey::KEY_LAST) + 1];

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	CWindowsSystem::CWindowsSystem(IEngine* pEngine)
		: ISystem(),
		m_pEngine(pEngine)
	{
	...
	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	void CWindowsSystem::Release()
	{
		delete this;
	}

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	bool CWindowsSystem::Initialize()
	{
        CWindowsSystem::InitializeKeyLookupTable();
	...
	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	bool CWindowsSystem::CreateWindow(const char* pTitle, uint32 width, uint32 height)
	{
		//Create window
		...
		{
			m_pWindow = pWindow;
			if (!m_pWindow->Initialize(pTitle, width, height))
			{
				return false;
			}
	...
	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	void CWindowsSystem::ProcessSystemEvents()
	{
		MSG message = {};
    ...
    /*////////////////////////////////////////////////////////////////////////////////////////////////*/
	LRESULT CALLBACK CWindowsSystem::MessageProc(HWND hWnd, uint32 message, WPARAM wParam, LPARAM lParam)
	{
		CWindowsSystem* pSystem = (CWindowsSystem*)IEngine::Get()->GetSystem();
		return pSystem->OnMessage(hWnd, message, wParam, lParam);
	}

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	LRESULT CWindowsSystem::OnMessage(HWND hWnd, uint32 message, WPARAM wParam, LPARAM lParam)
	{
        switch (message)
        {
        case WM_DESTROY:
        {
            m_pWindow->OnMessage(message, wParam, lParam);
            PostQuitMessage(0);
			return 0;
        }
        ...
        case WM_KEYDOWN:
        {
            ...
            event.KeyEvent.Key          = CWindowsSystem::ConvertFromVirtualKey(uint32(wParam));
            event.KeyEvent.Modifiers    = WindowsUtilities::GetModifierKeys();
        ...
        case WM_XBUTTONDOWN:
        {
            ...
            event.MouseButtonEvent.Modifiers = WindowsUtilities::GetModifierKeys();
	...
	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	void CWindowsSystem::OnSystemEvent(const SSystemEvent& event)
	{
		m_pEventDispatcher->DispatchEvent(event);
	}

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	void CWindowsSystem::AddEventListener(ISystemEventListener* pListener)
	{
		m_pEventDispatcher->AddEventListener(pListener);
	}

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	void CWindowsSystem::RemoveEventListener(ISystemEventListener* pListener)
	{
		m_pEventDispatcher->RemoveEventListener(pListener);
	}

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	EKey CWindowsSystem::ConvertFromVirtualKey(uint32 keycode)
	{
		return s_WindowsKeyTable[keycode];
	}

	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	uint32 CWindowsSystem::ConvertToVirtualKey(EKey keycode)
	{
		return s_KeyTable[uint32(keycode)];
	}

    /*////////////////////////////////////////////////////////////////////////////////////////////////*/
    void CWindowsSystem::InitializeKeyLookupTable()
    {
		//Set to zero
