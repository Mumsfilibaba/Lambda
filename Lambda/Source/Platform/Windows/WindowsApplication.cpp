...
namespace Lambda
{
	...
	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	void CWindowsApplication::RegisterWindowClass()
	{
		//Register window class
		WNDCLASSEX wc = {};
		wc.cbSize = sizeof(WNDCLASSEX);
		wc.style = CS_HREDRAW | CS_VREDRAW | CS_OWNDC;
		wc.lpfnWndProc = CWindowsApplication::MessageProc;
		wc.cbClsExtra = 0;
		wc.cbWndExtra = 0;
	...
	/*////////////////////////////////////////////////////////////////////////////////////////////////*/
	LRESULT CWindowsApplication::MessageProc(HWND hWnd, uint32 message, WPARAM wParam, LPARAM lParam)
	{
		return LRESULT();
	}
	...
	LRESULT CWindowsApplication::HandleMessage(HWND hWnd, uint32 message, WPARAM wParam, LPARAM lParam)
	{
        ...
        case WM_CREATE:
        {
            m_pWindow->HandleMessage(message, wParam, lParam);
            break;
        }
