...
namespace Math
{
	...
	{
#if defined(SSE_INTRIN)
		__m128	r0 = _mm_mul_ps(_mm_shuffle_ps(sse128[0], sse128[0], 0), other.sse128[0]);
		r0 = _mm_add_ps(r0, _mm_mul_ps(_mm_shuffle_ps(sse128[0], sse128[0], 0x55), other.sse128[1]));
		r0 = _mm_add_ps(r0, _mm_mul_ps(_mm_shuffle_ps(sse128[0], sse128[0], 0xaa), other.sse128[2]));
		r0 = _mm_add_ps(r0, _mm_mul_ps(_mm_shuffle_ps(sse128[0], sse128[0], 0xff), other.sse128[3]));

		__m128	r1 = _mm_mul_ps(_mm_shuffle_ps(sse128[1], sse128[1], 0), other.sse128[0]);
		r1 = _mm_add_ps(r1, _mm_mul_ps(_mm_shuffle_ps(sse128[1], sse128[1], 0x55), other.sse128[1]));
		r1 = _mm_add_ps(r1, _mm_mul_ps(_mm_shuffle_ps(sse128[1], sse128[1], 0xaa), other.sse128[2]));
		r1 = _mm_add_ps(r1, _mm_mul_ps(_mm_shuffle_ps(sse128[1], sse128[1], 0xff), other.sse128[3]));

		__m128	r2 = _mm_mul_ps(_mm_shuffle_ps(sse128[2], sse128[2], 0), other.sse128[0]);
		r2 = _mm_add_ps(r2, _mm_mul_ps(_mm_shuffle_ps(sse128[2], sse128[2], 0x55), other.sse128[1]));
		r2 = _mm_add_ps(r2, _mm_mul_ps(_mm_shuffle_ps(sse128[2], sse128[2], 0xaa), other.sse128[2]));
		r2 = _mm_add_ps(r2, _mm_mul_ps(_mm_shuffle_ps(sse128[2], sse128[2], 0xff), other.sse128[3]));

		__m128	r3 = _mm_mul_ps(_mm_shuffle_ps(sse128[3], sse128[3], 0), other.sse128[0]);
		r3 = _mm_add_ps(r3, _mm_mul_ps(_mm_shuffle_ps(sse128[3], sse128[3], 0x55), other.sse128[1]));
		r3 = _mm_add_ps(r3, _mm_mul_ps(_mm_shuffle_ps(sse128[3], sse128[3], 0xaa), other.sse128[2]));
		r3 = _mm_add_ps(r3, _mm_mul_ps(_mm_shuffle_ps(sse128[3], sse128[3], 0xff), other.sse128[3]));
