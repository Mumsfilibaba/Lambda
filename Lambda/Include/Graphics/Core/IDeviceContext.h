...
namespace Lambda
{
	...
	public:
        ...
        virtual void SetIndexBuffer(IBuffer* pBuffer, EFormat format) = 0;
        virtual void SetShaderVariableTable(IShaderVariableTable* pVariableTable) = 0;
        virtual void SetConstantBlocks(EShaderStage stage, uint32 offset, uint32 sizeInBytes, void* pData) = 0;
        virtual void SetPipelineState(IPipelineState* pPiplineState) = 0;

        virtual void UpdateBuffer(IBuffer* pResource, const SResourceData& data) = 0;
        virtual void UpdateTexture(ITexture* pResource, const SResourceData& data, uint32 mipLevel) = 0;
		...
		virtual void TransitionTextureStates(const STextureTransitionBarrier* pBarriers, uint32 numBarriers) = 0;
        ...
        virtual EDeviceContextType GetType() const = 0;
